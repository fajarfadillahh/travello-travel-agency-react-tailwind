  ...
  return (
    <header className="header fixed top-0 left-0 z-50 w-full">
      <div className="header__container container flex h-24 items-center justify-between">
        ...
        <div
          className={`header__menu fixed top-24 left-0 w-full origin-top bg-white py-8 px-16 text-center shadow-md transition-all duration-400 ${
            menuOpen ? "scale-y-100" : "scale-y-0"
          }`}
        >
          <ul className="header__list mb-8 flex flex-col gap-8">
            {[
              ["About", "/about"],
              ["Why Us", "/why-us"],
              ["Trips", "/trips"],
